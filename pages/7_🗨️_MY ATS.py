...
st.warning("""This System only works on local platform as it uses LLAMA CPP which is not designed to be deployedso for that reason to use this ATS you have to fork this repository and follow the below process. """)
